...
<div class="center1020">
	...
	(
	    ...
	    WHERE cont_ac.cid=cont.id AND cont_ac.yy=YEAR(NOW()) AND cont_ac.sid=serv.id AND cont.gr&1081004648040234863 > 0 AND cont_ac.mm = MONTH(DATE_ADD(NOW(), INTERVAL -1 MONTH))
	) AS "bnjuj"
	FROM contract_account AS cont_ac,  contract AS cont, service AS serv
